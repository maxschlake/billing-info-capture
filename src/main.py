...
# 1.1) Deskew
mod = "_deskew"
img = process.deskew(img)

# 3) Remove noise
# mod = "_denoise"
# denoisedImage = process.removeNoise(img, kernelSizeDil=1, iterationsDil=1, kernelSizeEr=1, iterationsEr=1, kernelSizeMorph=1, kernelSizeBlur=1)
